 ...
 * threads. */
void
mt_test_registration(void *args)
{
    hid_t                *vol_ids;
    herr_t                ret       = SUCCEED;
 ...
 * threads. */
void
mt_test_registration_by_name(void *args)
{
 ...
 * threads. */
void
mt_test_registration_by_value(void *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
...
void
mt_test_dyn_op_registration(void H5_ATTR_UNUSED *args)
{
...
void
mt_test_registration_operation(void *args)
{
...
void
mt_test_file_open_failure_registration(void H5_ATTR_UNUSED *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
 ...
 * correctly */
void
mt_test_vol_property_copy(void *args)
{
    hid_t  fapl_id = H5I_INVALID_HID;
    herr_t ret     = SUCCEED;
 ...
 */
void
mt_test_register_and_search(void *args)
{
...
void
mt_test_lib_state_ops(void H5_ATTR_UNUSED *args)
{
    void  *lib_state = NULL;
    herr_t ret       = SUCCEED;
...
void
mt_test_vol_wrap_ctx(void *args)
{
    hid_t  file_id         = H5I_INVALID_HID;
    herr_t ret             = SUCCEED;
    hid_t  fapl_id         = H5I_INVALID_HID;
 ...
 * so should probably have a counterpart placed in the API tests for use with various VOL connectors. */
void
mt_test_vol_info(void H5_ATTR_UNUSED *args)
{
