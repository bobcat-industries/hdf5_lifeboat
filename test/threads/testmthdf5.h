...
void mt_test_dyn_op_registration(void *args);
void mt_test_file_open_failure_registration(void *args);
void mt_test_vol_info(void *args);
void mt_test_vol_property_copy(void *args);
void mt_test_lib_state_ops(void *args);
...
void mt_test_library_init(void *args);
